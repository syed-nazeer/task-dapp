...
import img2 from './images/soleth.png';
import img3 from './images/meta.png';

// For path way : images must be in public folder
// For import way : image must be in the src folder
